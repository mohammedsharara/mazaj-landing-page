...
export const Hero: React.FC<HeroProps> = ({ onOpenOrderModal, onOpenImageStudio }) => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] md:min-h-screen pt-24 pb-14 flex items-center bg-[#FAFAFA] dark:bg-[#0D0D0D] text-neutral-900 dark:text-[#F7F4EF] overflow-hidden transition-colors duration-300"
    >
      {/* Subtle background ambient glow */}
      <div className="absolute top-1/4 right-0 w-96 h-96 bg-[#FFA000]/10 rounded-full blur-3xl pointer-events-none -z-0" />
      <div className="absolute bottom-10 left-10 w-72 h-72 bg-[#FFA000]/5 rounded-full blur-2xl pointer-events-none -z-0" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-7 flex flex-col text-right">
            {/* Top brand badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white dark:bg-[#1A1A1A] border border-neutral-200 dark:border-[#262626] shadow-sm w-fit mb-6 text-xs text-neutral-800 dark:text-[#F7F4EF]/90">
              ...
              <span className="text-[#FFA000] font-bold">MAZAJ WEAR</span>
            </div>

            {/* Headline */}
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-neutral-900 dark:text-[#F7F4EF] leading-[1.2] tracking-tight mb-5">
              فكرتك… <span className="text-[#FFA000]">نطبعها</span> ونحوّلها إلى قطعة تلبسها.
            </h1>

            {/* Subheadline */}
            <p className="text-base sm:text-lg lg:text-xl text-neutral-600 dark:text-[#A5A5A5] font-normal leading-relaxed mb-8 max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3.5 sm:gap-4 mb-8">
              <button
                ...
                className="bg-[#FFA000] hover:bg-[#e68a00] text-[#0D0D0D] font-extrabold text-base sm:text-lg px-8 py-3.5 rounded-xl transition-all duration-200 shadow-xl shadow-[#FFA000]/25 flex items-center justify-center gap-2 active:scale-95 cursor-pointer text-center"
              >
              ...
              <button
                ...
                className="bg-white dark:bg-[#1A1A1A] hover:bg-neutral-100 dark:hover:bg-[#262626] text-neutral-800 dark:text-[#F7F4EF] font-bold text-base px-6 py-3.5 rounded-xl border border-neutral-300 dark:border-[#333333] transition-colors flex items-center justify-center gap-2 cursor-pointer text-center shadow-sm"
              >
            ...
            {/* Small Trust Line */}
            <div className="pt-4 border-t border-neutral-200 dark:border-[#1F1F1F] flex flex-wrap items-center gap-y-2 gap-x-4 text-xs sm:text-sm text-neutral-600 dark:text-[#A5A5A5] font-medium">
              ...
              <span className="text-neutral-300 dark:text-[#333333] hidden sm:inline">•</span>
              <span className="flex items-center gap-1.5 text-neutral-900 dark:text-[#F7F4EF]/90 font-semibold">
                <CheckCircle className="w-4 h-4 text-[#FFA000]" />
